...
export function HangarFlightDeck() {
    ...
    return (
        <div className="h-full w-full bg-[#050505] text-zinc-300 font-mono flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto lg:overflow-hidden flex flex-col lg:grid lg:grid-cols-12 p-4 lg:p-6 gap-6">

                {/* 1. Backlog / Queue */}
                <div className="w-full lg:col-span-4 h-[500px] lg:h-auto bg-zinc-900/20 border border-zinc-800/50 rounded-lg flex flex-col overflow-hidden shrink-0">
                ...
                {/* 2. Active Protocol (Chat Interface) */}
                <div className="w-full lg:col-span-4 h-[600px] lg:h-auto bg-zinc-900/20 border border-zinc-800/50 rounded-lg flex flex-col overflow-hidden relative shrink-0">
                    <div className="p-3 border-b border-zinc-800/50 bg-emerald-950/10 font-bold text-xs text-emerald-400 uppercase tracking-widest flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span>{activeTask ? `Active: ${activeTask.id.slice(0, 6)}` : "Systems Idle"}</span>
                        </div>
                        {activeTask && (
                            <>
                                <button
                ...
                {/* 3. Mission Log (Done) */}
                <div className="w-full lg:col-span-4 h-[400px] lg:h-auto bg-zinc-900/20 border border-zinc-800/50 rounded-lg flex flex-col overflow-hidden shrink-0">
