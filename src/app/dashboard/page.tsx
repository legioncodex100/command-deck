            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <section className="lg:col-span-2 flex flex-col gap-4">
                    ...
                    <div className="bg-[#0a0a0a] border border-zinc-800/50 rounded-xl min-h-[400px] p-6 relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-emerald-500/0 via-emerald-500/20 to-emerald-500/0 opacity-50"></div>
                        <ProjectVault />
                    </div>
                </section>
                ...
                <aside className="space-y-8">
                    ...
                    <div className="bg-[#0a0a0a] border border-zinc-800/50 rounded-xl p-6 relative group">
                        <div className="absolute -inset-px bg-gradient-to-b from-emerald-500/20 to-transparent opacity-0 group-hover:opacity-10 rounded-xl transition-opacity pointer-events-none" />
                        ...
                        <div className="relative border-l border-zinc-800 ml-1.5 space-y-6">
                            {[
                                ...
                                <div key={i} className="pl-6 relative group">
                                    <div className="absolute -left-[5px] top-1.5 h-2.5 w-2.5 rounded-full bg-zinc-900 border border-zinc-700 group-hover:border-emerald-500 group-hover:bg-emerald-950 transition-colors" />
